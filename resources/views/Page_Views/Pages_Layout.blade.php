                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-7 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            <li><a class="active" href="{{URL::to('/')}}">{{__('TRANG CHỦ')}}</a></li>
                                            <li><a class=""
                                                    href="{{URL::to('/destination')}}">{{__('ĐIỂM ĐẾN')}}</a></li>
                                            <li><a class=""
                                                    href="{{URL::to('type-of-tour')}}">{{__('LOẠI DU LỊCH')}}</a>
                                            </li>
                                            <li><a class="" href="{{URL::to('post')}}">{{__('BÀI VIẾT')}}</a></li>
                                            <li><a class="" href="{{URL::to('wishlist')}}">{{__('KHÁCH HÀNG')}}</a>
                                            </li>
                                            {{--<li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            ...
                            <p>1ST Floor, No 1 Le Đinh Ly Street,<br> Thanh Khe District <br> Da Nang, Viet Nam <br>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            </script> All rights reserved | <a href="#" target="_blank">Viet
                                Trip </a>
                        </p>
                    </div>
                </div>
