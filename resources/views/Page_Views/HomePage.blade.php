                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <a href="{{URL::to('destination/Phuquoc')}}" class="boxed-btn3">Explore Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="more_place_btn text-center">
                        <a class="boxed-btn4" href="/travel/public/destination">{{__('Xem thêm')}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="thumbnail">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section_title text-center mb_70">
                            ...
                            <p>{{__('Hãy lựa chọn chuyến đi của bạn cùng Vietrip trong các chuyên mục của chúng tôi, chúng tôi có những lựa chọn tốt nhất và phù hợp nhất cho bạn, từ lãng mạn đến mộng mơ….')}}</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="more_place_btn text-center">
                            <a class="boxed-btn4" href="/travel/public/type-of-tour">{{__('Xem thêm')}}</a>
                        </div>
                    </div>
                </div>
            </div>
