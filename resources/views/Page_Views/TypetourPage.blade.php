    ...
    <div class="col-md-12 col-sm-12" style="padding-top:80px">
        <div class="container">
            <h2 class="wow fadeInUp" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;text-align: center;font-family: 'Philosopher';font-weight: bolder">
                {{__('Hãy lựa chọn chuyến đi của bạn với Vietrip trong danh mục của chúng tôi, chúng tôi có những lựa chọn tốt nhất và phù hợp nhất cho bạn, từ tuần trăng mật lãng mạn và thơ mộng, những chuyến du lịch thư giãn nhưng không kém phần mạo hiểm cùng bạn bè hoặc gia đình, đến những chuyến du lịch văn hóa và truyền thống đáng nhớ để khám phá cuộc sống của quá khứ … Tất cả các lựa chọn phụ thuộc vào bạn, vào ngân sách của bạn và sở thích của bạn.')}}
            </h2>
        </div>
    </div>
