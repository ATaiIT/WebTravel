...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">{{__('Thêm Tour')}}</h4>
            ...
            <form role="form" action="{{URL::to('/save-tour')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex no-block align-items-center">
                        <h4 class="card-title">{{__('THÊM TOUR')}}</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="com1"
                                    class="control-label col-form-label">{{__("Tên tiếng Việt")}}</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Giá Tour")}}</label>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="control-label col-form-label">{{__('Ngày khởi hành')}}</label>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <label for="">{{__('Khoảng thời gian')}}</label>
                            <div class="row ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label for="">{{__('Giá người lớn')}}</label>
                            <div class="row ">
                                <div class="col-12">
                                <input onkeypress="return fun_AllowOnlyAmountAndDot(this.id)" type="text"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">{{__('Lịch trình Tour')}}</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">{{__('Chi tiết lịch trình')}}</label>
                                <div class="control-group" id="fields">
                                    <div class="controls">
                                        <div class="entry input-group ">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">{{__('Maps')}}</label>
                                <div class="control-group" id="fields">
                                    <div class="entry input-group ">
                    ...
                    <label for="">{{__('Dịch vụ tour')}}</label>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                    ...
                    <label for="">{{__('Tour nổi bật')}}</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label col-form-label">{{__('Ẩn/hiện')}}</label>
