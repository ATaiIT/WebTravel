...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">{{__('Chi tiết đặt chỗ')}}</h4>
            ...
            <form role="form" action="{{URL::to('/update-booking')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Giá tour cơ bản")}}</label>
                        ...
                        <div class="col-6">
                            <?php
                                ...
                                ?>
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Tổng cộng")}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Ngày đặt")}}</label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Ngày yêu cầu")}}</label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Ghi chú")}}</label>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-md-flex align-items-center">
                                        <div>
                                            <h4 class="card-title">{{__('Lịch sử liên hệ khách hàng')}}</h4>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label
                                    class="control-label col-form-label">{{__('Thêm lịch sử liên hệ khách hàng ')}}</label>
