...
?>
                    <li class="p-15 mt-2"><a href="{{URL::to('dashboard')}}" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-chart-area"></i> <span class="hide-menu ml-1">{{__('TRANG QUẢN LÝ')}}</span> </a></li>
                    <?php
                    }elseif(Session::get('position_id')==3){
                        ?>
                        <li class="p-15 mt-2"><a href="{{URL::to('dashboardkd')}}" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-chart-area"></i> <span class="hide-menu ml-1">{{__('TRANG QUẢN LÝ')}}</span> </a></li>
                        <?php
                    }elseif(Session::get('position_id')==4){
                        ?>
                        <li class="p-15 mt-2"><a href="{{URL::to('dashboardhd')}}" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-chart-area"></i> <span class="hide-menu ml-1">{{__('TRANG QUẢN LÝ')}}</span> </a></li>
                    <?php
                    }
                    ?>
                    <!-- User Profile-->
                    ...
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map-marker-radius"></i><span class="hide-menu">{{__('ĐIỂM ĐẾN')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/add-destination')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm điểm đến')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-destination')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liệt kê các điểm đến')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-firefox"></i><span class="hide-menu" >{{__('LOẠI TOUR')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/add-type-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm loại du lịch')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-type-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liệt kê loại hình du lịch')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-map"></i><span class="hide-menu">{{__('TOURS')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/add-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm chuyến tham quan')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-tour')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liệt kê các chuyến tham quan')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-firefox"></i><span class="hide-menu" >{{__('BÀI ĐĂNG')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/add-post')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm bài đăng')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-post')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liệt kê bài đăng')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    {{--End tour manager--}}
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ ĐẶT CHỖ')}}</span></li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-save-all"></i><span class="hide-menu">{{__('HỢP ĐỒNG')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/new-contract')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liên hệ mới')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-contract/1')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Chờ xác nhận')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                            <a href="{{URL::to('/list-contract/2')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Hoàn thành hợp đồng')}} </span></a>
                                
                            </li>
                            <li class="sidebar-item">
                            <a href="{{URL::to('/list-contract/3')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Các hợp đồng đã hoàn thành')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-contract/0')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Hủy hợp đồng')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-file-document"></i><span class="hide-menu">{{__('ĐẶT TRƯỚC')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-booking/0')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Chưa xác nhận')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-booking/1')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Đã xác nhận')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-booking/2')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Đã hủy')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    {{--End booking manager--}}
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ TOUR DU LỊCH')}}</span></li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-save-all"></i><span class="hide-menu">{{__('CONTRACTS')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('/new-custom-contract')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Liên hệ mới')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-custom-contract/1')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Chờ xác nhận')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-custom-contract/3')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Hoàn thành hợp đồng')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-custom-contract/2')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Các hợp đồng đã hoàn thành')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('/list-custom-contract/0')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Hủy hợp đồng')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    {{--End booking manager--}}
                    {{--start staff manager--}}
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ NHÂN VIÊN')}}</span></li>
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-nature-people"></i><span class="hide-menu">{{__('NHÂN VIÊN')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{URL::to('add-staff')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Thêm nhân viên')}} </span></a>
                            </li>
